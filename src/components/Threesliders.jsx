...
const Threesliders = () => {
    ...
    return (
        <>
            <h2 data-aos="fade-up" className='text-[#02CDCF] lg:mt-[150px] md:mt-[100px] mt-[80px] xl:mt-[200px] font-bold text-[32px] text-center sm:text-[40px] mb-4 ff-recharge sm:leading-[50.4px] leading-[45px]' id='about'>NexAi does all this. And more.</h2>
