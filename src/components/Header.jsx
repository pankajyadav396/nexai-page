  ...
  return (
    <>
      <div id='home' className="mt-4 bg-[url(./assets/images/webp/heroimg.webp)] min-h-screen min-[1200px]:h-[810px] w-full bg-center bg-no-repeat bg-cover min-[1400px]:bg-contain relative flex flex-col">
        <Navbar />
        <div className="grow max-w-[1164px] w-full flex flex-col justify-center min-[1200px]:justify-start mx-auto px-3 min-[1200px]:mt-[184px]">
          <div className="max-w-[577px] w-full">
            <p data-aos="zoom-out" data-aos-delay="3000" className="ff-recharge font-bold text-[35px] sm:text-[60px] sm:leading-[75.6px] text-white">
              <span className="text-[#02CDCF]">Nexai</span> is an advanced
              AI-powered home assistant
            </p>
            <p data-aos="zoom-out" data-aos-delay="3000" className="mt-4 mb-[51px] font-['poppins'] font-normal text-base leading-[25.6px] text-white">
