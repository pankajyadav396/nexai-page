            ...
            <div className='max-w-[1340px] min-[1600px]:max-w-[1440px] mx-auto px-3 z-[1] border-[2px] border-white rounded-[20px] overflow-hidden h-[810px] bg-center relative bg-[url(./assets/images/webp/Uniqe-bg.webp)] bg-cover'>
                ...
                <div className=' h-full w-full'>
                    <div className='sm:px-3 md:px-7 lg:px-[80px]'>
                        <h3 data-aos="zoom-in" className='ff-recharge text-[32px] font-bold sm:text-[35px] md:text-[40px] text-center text-white mt-[40px] md:mt-[80px]'>Unique features</h3>
                        ...
                        <div className='overflow-y-scroll overflow-x-hidden h-[600px] sm:h-[585px] md:h-[570px] pb-[40px]  sm:pb-[50px]'>
                            {uniqeFeaturesList.map((obj, index) => {
                                return (
                                    <div key={index} className={`${index % 2 !== 0 ? ' justify-center min-[820px]:justify-end' : 'justify-center min-[820px]:justify-start'} flex`}>
                                        <div className={`bg-white sm:max-w-[350px] max-w-[300px] sm:min-h-[400px] min-h-[280px] rounded-[16px] sm:p-[30px_24px] px-[18px] py-5 mb-4 hover:scale-95 duration-300 hover:shadow-2xl ${index !== 0 ? ' min-[820px]:mt-[-115px]' : 'mt-5'} `}>
                                            ...
                                            <h5 className='ff-recharge text-[15px] font-bold sm:text-[20px] text-black mx-w-[350px] mt-4 mb-3'>
                                                {obj.title}</h5>
