                    ...
                    <div className='flex flex-wrap flex-col-reverse md:flex-row -mx-3 min-[1440px]:w-[100%]'>
                        <div className='md:w-1/2 w-full px-3 mb-10 md:mb-0 flex flex-col items-center'>
                            <div className='max-w-[500px]'>
                                <h2 data-aos="fade-up" className='text-[#02CDCF] max-md:text-center text-nowrap md:max-w-[480px] font-bold text-[32px] sm:text-[40px] md:text-[30px] lg:text-[40px] mb-4 ff-recharge sm:leading-[50.4px] leading-[45px]'>What is NexAi?</h2>
