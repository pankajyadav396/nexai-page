    ...
    return (
        <>
            <div className='relative'>
                <h2 data-aos="fade-up" className='text-[#02CDCF] mt-[70px] md:mt-[100px] lg:mt-[160px] font-bold text-[32px] sm:text-[40px] text-center md:text-[30px] lg:text-[40px] mb-4 ff-recharge sm:leading-[50.4px] leading-[45px]'>Blockchain & AI technology</h2>
